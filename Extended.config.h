...
#define SERIAL_IP_MODE      OFF //     STATION //STATION // OFF //         OFF, Use STATION to enable the interface (ESP32 only.)                   Option
// IP ADDRESS SETTINGS -------------------------------------------------------------------------------------------------------------
 ...
 #define ONSTEP2_HOST_NAME      "ASiair" //          "", Wifi Host Name to connnect to, leave blank to disable.              Adjust
 #define ONSTEP2_SSID           "ASiairHPWR2" //    "ONSTEP", Wifi alternate Station SSID to connnect to.                         Adjust
 #define ONSTEP2_PASSWORD       "12345678" //          "", Wifi alternate Station mode password.                               Adjust
