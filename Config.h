...
#define DISPLAY_OLED       SSD1306    //    SH1106 // SSD1309  SH1106, OLED 1.3" I2C display commonly used. SSD1306 is a 0.96" OLED display.    Infreq
...
// Override encoder serial bridge baud rate (change if your encoder bridge uses a different speed)
#ifndef SERIAL_ENCODER_BAUD
#define SERIAL_ENCODER_BAUD 115200
#endif
#define SERIAL_ONSTEP_RX 16
#define SERIAL_ONSTEP_TX 17

// USER FEEDBACK -------------------------------------------------------------------------------------------------------------------
#define UTILITY_LIGHT                 OFF //    OFF, n. Where n=0..255 (0..100%) activates feature sets default brightness.   Adjust

// WEATHER SENSOR ------------------------------------------------------------------------------------------------------------------
#define WEATHER                   OFF //     OFF //    OFF, BME280 (I2C 0x77,) BME280_0x76, BMP280 (I2C 0x77,) BMP280_0x76           Option
...
// SQM SENSOR ------------------------------------------------------------------------------------------------------------------
#define SKY_QUAL            OFF  //     OFF   ON  or TSL2591  Support SQM  sensor
...
// Local Realt Timec
#define LOCAL_RTC            DS3231 //    OFF, DS3231 (I2C,)  Option
                                          //         Provides Date/Time
