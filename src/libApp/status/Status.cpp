...
//      VF("MSG:TelStatus: "); VL(TelStatus) ;
     ...
     memset(reply, (uint8_t)0b10000000, 9); 
// NG010000291#
// nNG000000290#
// 0123456789
// OnStep bit mount code  “:Gu#”    
 ...
 if ( (TelStatus[0] == 'n') &&  (TelStatus[1] != 'N') )  reply[0]=0b10000001;     // Goto 
 if ( (TelStatus[0] == 'n') && ( (TelStatus[3] == '1') || (TelStatus[5] == '1')) )  reply[0]=0b10000001;  // Slewing 
